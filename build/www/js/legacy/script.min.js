...
function loadTest() {
  var loadingCursor = [
    "./img/cursors/hourglas.webp",
    "./img/cursors/hourgla2.webp",
    "./img/cursors/hourgla3.webp",
    "./img/cursors/barber.webp",
    "./img/cursors/horse.webp",
    "./img/cursors/wagtail.webp",
    "./img/cursors/drum.webp",
    "./img/cursors/dinosaur.webp",
    "./img/cursors/dinosau2.webp",
    "./img/cursors/banana.webp",
    "./img/cursors/metronom.webp",
    "./img/cursors/piano.webp",
    "./img/cursors/handwait.webp",
    "./img/cursors/stopwtch.webp",
  ]
  $("#login_card").hide(),
    $("#login_error").hide(),
    $("#login_load").show(),
        ...
        },
        {
          ...
          value: function(a) {
            ...
            if (safeMode) {
              ...
              this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/" + seecretColor[Math.floor(Math.random() * seecretColor.length)] + ".webp"], frames: info.frames, animations: info.animations }), a ? "gone" : "idle")), (this.sprite.id = this.id));
              ...
              this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/empty.webp"], frames: info.frames, animations: info.animations }), a ? "gone" : "idle")), (this.sprite.id = this.id));
              b.addChild(this.sprite);
