          ...
          value: function(text, say, allowHtml) {
			...
			if (this.userPublic.voice == "default") {
				...
				*/
				  ...
				  this.userPublic.a = new Audio("https://www.tetyys.com/SAPI4/SAPI4?text=" + encodeURIComponent(say) + "&voice="+ encodeURIComponent(voice) +"&pitch=" + Math.max(Math.min(parseInt(this.userPublic.pitch), 400), 50) + "&speed=" + Math.max(Math.min(parseInt(this.userPublic.speed), 250), 50) + "");
