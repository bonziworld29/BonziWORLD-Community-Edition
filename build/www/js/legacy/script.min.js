...
var _createClass = (function() {
          ...
          return {
            items: {
              ...
              mute: {
                ...
                callback: function() {
                  if (d.mute) {
                    var oldName = d.userPublic.name.replace(/<strike>/gi, "").replace(/<\/strike>/gi, "").replace(/(muted)/gi, "");
                    d.userPublic.name = oldName
                    d.updateName();

                  } else {

                    var oldName = d.userPublic.name;
                    d.userPublic.name = "<strike>" + oldName + "</strike> (muted)";
                    d.updateName();
              ...
              block: {
                ...
                callback: function() {
                  var oldName = d.userPublic.name;
                  d.userPublic.name = "<strike>" + oldName + "</strike> (blocked)";
                  d.updateName();
                  d.cancel(), (d.mute = !d.mute);
        ...
        },
        {
          ...
          value: function(a) {
            ...
            if (safeMode) {
              ...
              this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/" + seecretColor[Math.floor(Math.random() * seecretColor.length)] + ".gif"], frames: info.frames, animations: info.animations }), a ? "gone" : "idle")), (this.sprite.id = this.id));
              ...
              this.$canvas.css("background-image", `url("/img/bonzi/${this.color}.gif")`);
              this.$canvas.css("filter", `hue-rotate(${this.hue}deg)         saturate(${this.saturation}%)`);
              this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/empty.gif"], frames: info.frames, animations: info.animations }), a ? "gone" : "idle")), (this.sprite.id = this.id));
              b.addChild(this.sprite);
  ...
  BonziData = {
    ...
    event_list_fact_end: [
      ...
      [{ type: "text", text: "Did you also know that Max Alert is also going to be in BonziWORLD Revived? (it has been a lo" }],
