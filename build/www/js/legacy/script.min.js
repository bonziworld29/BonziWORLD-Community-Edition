      ...
      _createClass(constructor, [
        ...
        },
        {
          ...
          value: function(text, say, allowHtml) {
            ...
            (allowHtml = allowHtml || !1),
              ...
              "undefined" != typeof say ? ((say = replaceAll(say, "{NAME}", this.userPublic.name)), (say = replaceAll(say, "{COLOR}", this.color))) : (say = a.replace("&gt;", ""));
            //(a = linkify(a));
            // temporarily disable linkify until we find a fix
            var e = "&gt;" == text.substring(0, 4) || ">" == text[0];
            this.$dialogCont[allowHtml ? "html" : "text"](text)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block");
            ...
            if (document.documentMode == 11) {
              ...
              speakers.speak(say.toLowerCase());
        ...
        },
        {
          ...
          value: function(swag) {
            ...
            swag && (b.push({ type: "anim", anim: "cool_fwd", ticks: 40 }), b.push({ type: "idle" })), this.runSingleEvent(b);
          },
        },
        {
          key: "clap",
        ...
        },
        {
          ...
          value: function(target) {
            this.runSingleEvent([{ type: "text", text: "Hey, " + target + "!" }, { type: "text", text: "You're a fucking asshole!", say: "your a fucking asshole!" }, { type: "anim", anim: "grin_fwd", ticks: 25 }, { type: "idle" }]);
          },
        },
        {
          key: "beggar",
