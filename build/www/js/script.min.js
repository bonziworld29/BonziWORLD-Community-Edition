...
var _createClass = (function() {
  ...
  BonziData = {
    ...
    event_list_fact_end: [
      ...
      /*[{ type: "text", text: "Did you also know that Max Alert is also going to be in BonziWORLD? (it has been a long time ago man.. can we just remove this fact?)" }],*/
      [{ type: "text", text: "Reminder: You cannot have pope, god, or that forbidden dude's color. Only people who have the godmode password can change the color to those." }],
