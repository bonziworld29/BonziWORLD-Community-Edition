        ...
        },
        {
          ...
          value: function(a) {
            ...
            if (safeMode) {
              ...
              this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/" + this.color + ".gif"], frames: info.frames, animations: info.animations }), a ? "gone" : "idle")), (this.sprite.id = this.id));
              b.addChild(this.sprite);
              this.move();
            }
          },
